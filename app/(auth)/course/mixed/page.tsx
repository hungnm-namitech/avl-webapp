...
import TableDetailCourseMixed from '@/app/components/course/TableDetailCourseMixed';
...
const DetailCourseMixed = (props: Props) => {
    ...
    <div className='p-10 pb-16 pt-7'>
      ...
      <div className='mt-[30px] flex gap-9'>
        <div className='flex-1'>
          <div className='flex flex-col gap-16 pc:max-w-full'>
            <div>
              <TitleComponent content='基本情報' id='basic_information' />
              <div className='mt-6 pc:max-w-full'>
                <DetailRow
                  items={[
                    {
...
export default DetailCourseMixed;
