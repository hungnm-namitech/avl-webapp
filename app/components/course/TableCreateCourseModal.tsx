...
import { ArrowSort, Calendar, Car, Home, PencilEdit } from '../svg';
...
export default function TableCreateCourseModal() {
      ...
      case 'loadingDate':
        return (
          <span className='flex items-center gap-2'>
            {course.loadingDate} <Calendar />
          </span>
        );
      case 'unloadingDate':
        return (
          <span className='flex items-center gap-2'>
            {course.unloadingDate} <Calendar />
          </span>
        );
      case 'unloadingTime':
        return <span className='flex items-center gap-2'>00:05</span>;
      case 'groupId':
        return (
