...
import { detailCourseLogistic } from '../../constants/course.cont';
...
type Course = (typeof detailCourseLogistic)[0];

export default function TableDetailCourseLogistic() {
  ...
  const sortedItems = React.useMemo(() => {
    return detailCourseLogistic.sort((a: Course, b: Course) => {
